...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        final String projectPath = "E:/zzp/code_temp/examples";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/spring-cloud-seckill?zeroDateTimeBehavior=convertToNull&useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&useOldAliasMetadataBehavior=true&useSSL=false");
